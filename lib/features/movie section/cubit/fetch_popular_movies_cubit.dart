...
class FetchPopularMoviesCubit extends Cubit<CommonState> {
  final MovieRepository movieRepository;
  FetchPopularMoviesCubit({required this.movieRepository})
      : super(CommonInitialState());

  fetchPopularMovies({required String movieType}) async {
